...
class User_Edit_Comment_Manager(models.Manager):
...
class User_Edit_Comment(models.Model):
    edit_comment = models.CharField(max_length=250)
    edit_user = models.ForeignKey(User, related_name = "edit_cmnts")
    objects = User_Edit_Comment_Manager()

class Message(models.Model):
    message = models.CharField(max_length=3000)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    msg_entered_by = models.ForeignKey(User, related_name = "msgs_entered")
    msg_linked_to = models.ForeignKey(User, related_name = "msgs_owned")
...
class Comment(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    cmnt_entered_by = models.ForeignKey(User, related_name = "cmnts_entered")
    cmnt_linked_to = models.ForeignKey(User, related_name = "cmnts_owned")
